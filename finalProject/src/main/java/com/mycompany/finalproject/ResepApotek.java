...
public class ResepApotek {
    ...
    public ResepApotek(String namaPasien, String Tgllahir, String Asuransi, String Diag, String Dokter, String Resep ) {
    ...
    public String toString() {
        return String.format("[{namaPasien:%s, Dokter:%s, Tgllahir:%s, Asuransi:%s, Diag:%s, Resep:%s}]",
                namaPasien, Dokter, Tgllahir, Asuransi, Diag, Resep);
    ...
    public void toObject(String string) {
        ...
        if (namaPasienIndex != -1 && DokterIndex != -1 && TgllahirIndex != -1 && asuransiIndex != -1 && diagIndex != -1) {
