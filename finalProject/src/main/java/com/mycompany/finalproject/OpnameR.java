...
public class OpnameR {
    ...
    public OpnameR(String noKtp, String namaPasien, String Dokter, String Tgllahir, String Asuransi, String Diag, String Kamar) {
        this.noKtp = noKtp;
    ...
    public String toString() {
        return String.format("[{noKtp:%s, namaPasien:%s, Dokter:%s, Tgllahir:%s, Asuransi:%s, Diag:%s, Resep:%s}]",
                noKtp, namaPasien, Dokter, Tgllahir, Asuransi, Diag, Kamar);
    ...
    public void toObject(String string) {
        ...
        if (noKtpIndex != -1 && namaPasienIndex != -1 && DokterIndex != -1 && TgllahirIndex != -1 && asuransiIndex != -1 && diagIndex != -1) {
            ...
            Kamar = extractValue(string, ResepIndex + 6, string.indexOf("]") -2);
            ...
            System.out.println("Resep: " + Kamar);
        } else {
